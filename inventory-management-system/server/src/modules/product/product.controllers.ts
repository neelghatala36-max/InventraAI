...
class ProductControllers {
  ...
  /**
   * Get single product of user by skuId
   */
  readBySku = asyncHandler(async (req, res) => {
    const result = await this.services.readBySku(req.query.sku_id as string, req.user._id);
